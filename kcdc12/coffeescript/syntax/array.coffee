...
window.syntax.array = ->
  ...
  a = [1, 2, 3, 4, 5]
  console.log 'true' if 5 in a # true
  ...
  a = ['PHP', 'C#', 'Python', 'CoffeeScript', 'Perl', 'Clojure']
  for lang in a
    console.log lang # PHP Python CoffeeScript Perl Clojure
    
  console.title 'iterating over an array conditionally'
  a = ['PHP', 'C#', 'Python', 'CoffeeScript', 'Perl', 'Clojure']
  for lang in a when lang[0] == 'P'
    console.log lang # PHP Python Perl
